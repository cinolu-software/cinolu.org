...
import { DashboardEventCategoriesStore } from '../../data-access/event-categories/event-categories.store';

@Component({
  selector: 'app-dashboard-event-categories',
  templateUrl: './event-categories.component.html',
  providers: [DashboardEventCategoriesStore],
  imports: [
    LucideAngularModule,
    CommonModule,
    TableModule,
...
export class DashboardEventCategoriesComponent {
  #route = inject(ActivatedRoute);
  #router = inject(Router);
  #fb = inject(FormBuilder);
  searchForm: FormGroup;
  store = inject(DashboardEventCategoriesStore);
