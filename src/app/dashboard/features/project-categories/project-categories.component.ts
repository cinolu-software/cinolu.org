...
import { DashboardProjectCategoriesStore } from '../../data-access/project-categories/project-categories.store';

@Component({
  selector: 'app-dashboard-project-categories',
  templateUrl: './project-categories.component.html',
  providers: [DashboardProjectCategoriesStore],
  imports: [
    LucideAngularModule,
    CommonModule,
    TableModule,
...
export class DashboardProjectCategoriesComponent {
  #route = inject(ActivatedRoute);
  #router = inject(Router);
  #fb = inject(FormBuilder);
  searchForm: FormGroup;
  store = inject(DashboardProjectCategoriesStore);
