...
interface IDashboardEventCategoriesStore {
  isLoading: boolean;
  isFiltering: boolean;
  categories: [ICategory[], number];
}

export const DashboardEventCategoriesStore = signalStore(
  withState<IDashboardEventCategoriesStore>({ isLoading: false, isFiltering: false, categories: [[], 0] }),
  withProps(() => ({
