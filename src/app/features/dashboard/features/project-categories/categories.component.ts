...
import { CategoriesStore } from '../../data-access/project-categories/categories.store';
import { AddCategoryStore } from '../../data-access/project-categories/add-category.store';
import { DeleteCategoryStore } from '../../data-access/project-categories/delete-category.store';
import { UpdateCategoryStore } from '../../data-access/project-categories/update-category.store';
