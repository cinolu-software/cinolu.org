...
export const ENTREPRENEURS_DATA: IEntrepreneur[] = [
  {
    ...
    socials: [{ website: 'https://afritech.cd' }, { linkedin: 'https://linkedin.com/in/sarahkabeya' }],
    products: [
      {
        id: 101,
  ...
  },
  {
    ...
    category: 'Mode',
    socials: [{ website: 'https://congowear.cd' }, { linkedin: 'https://linkedin.com/in/patrickmwamba' }],
    products: [
      {
        id: 102,
