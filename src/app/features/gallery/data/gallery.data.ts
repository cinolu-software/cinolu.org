...
export const GALLERY_IMAGES: IGalleryImage[] = [
  ...
  { src: 'images/gallery/4.jpg', alt: 'Travail en groupe pendant la session', category: 'Pratique' },
  { src: 'images/gallery/5.jpg', alt: 'Échange entre participants', category: 'Atelier' },
  { src: 'images/gallery/6.jpg', alt: 'Vue générale de la salle de formation', category: 'Atelier' },
  { src: 'images/gallery/7.jpg', alt: 'Présentation projetée à l’écran', category: 'F-360' },
  {
  ...
  { src: 'images/gallery/16.jpg', alt: 'Formateur expliquant au tableau', category: 'F-360' },
  { src: 'images/gallery/17.jpg', alt: 'Vue rapprochée des participants', category: 'L-Impact' },
  { src: 'images/gallery/18.jpg', alt: 'Interaction entre deux participants', category: 'Atelier' },
  { src: 'images/gallery/19.jpg', alt: 'Pratique individuelle guidée', category: 'L-Impact' },
  {
  ...
  { src: 'images/gallery/26.jpg', alt: 'Formateur répondant à une question', category: 'Atelier' },
  { src: 'images/gallery/27.jpg', alt: 'Vue arrière de la salle en activité', category: 'Atelier' },
  { src: 'images/gallery/28.jpg', alt: 'Moment de pause et d’échanges', category: 'Atelier' },
  { src: 'images/gallery/29.jpg', alt: 'Présentation d’un cas pratique', category: 'Atelier' },
  {
