...
export const routes: Route[] = [
  ...
  },
  {
    ...
    component: Layout,
    data: { layout: 'fixed-layout' },
    loadChildren: () => import('./features/our-parteners/parteners.route').then((m) => m.OurParteners),
  },
  {
    path: 'our-programs',
    component: Layout,
  ...
  },
  {
    ...
    loadChildren: () => import('./features/jobs-opportunities/jobs.routes').then((m) => m.jobsRoutes),
  },
  {
    path: 'events',
    component: Layout,
  ...
  },
  {
    ...
    component: Layout,
    data: { layout: 'full-layout' },
    loadChildren: () => import('./features/galerry/gallery.routes').then((m) => m.galleryRoutes),
  },
  {
    path: 'contact-us',
    component: Layout,
    data: { layout: 'full-layout' },
    loadChildren: () => import('./features/contact-us/contact-us.route').then((m) => m.contactUsRoutes),
  },
  {
    path: 'dashboard',
    component: Layout,
